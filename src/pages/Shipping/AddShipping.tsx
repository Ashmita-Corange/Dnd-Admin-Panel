...
import { createShipping } from "../../store/slices/shippingSlice";
...
export default function AddShipping() {
  ...
  return (
    <div>
      ...
      <PageMeta
        title="Add Shipping Method | TailAdmin"
        description="Add a new shipping method for TailAdmin"
      />
      <div className="h-fit rounded-2xl border border-gray-200 bg-white px-5 py-7 dark:border-gray-800 dark:bg-white/[0.03] xl:px-10 xl:py-12">
        <div className="mx-auto w-full">
          <PageBreadcrumb pageTitle="Add Shipping Method" />
