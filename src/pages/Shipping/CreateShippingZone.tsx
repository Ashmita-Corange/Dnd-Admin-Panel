...
import { createShippingZone } from "../../store/slices/shippingZone";
...
const CreateShippingZone: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const createdZone = await dispatch(createShippingZone(zoneData)).unwrap();

      console.log("Created Shipping Zone:", createdZone);
      ...
      setPopup({
        isVisible: true,
        message:
          err?.message || "Failed to create shipping zone. Please try again.",
        type: "error",
      });
    }
  };
  ...
  return (
    <div>
      ...
      <PageMeta
        title="Create Shipping Zone | TailAdmin"
        description="Create a new shipping zone for TailAdmin"
      />
      <div className="h-fit rounded-2xl border border-gray-200 bg-white px-5 py-7 dark:border-gray-800 dark:bg-white/[0.03] xl:px-10 xl:py-12">
        <div className="mx-auto w-full">
          <PageBreadcrumb pageTitle="Create Shipping Zone" />
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-6 border-b border-gray-200 dark:border-gray-700 pb-6">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Choose the shipping method for which you want to create zones
                </p>
              </div>
            ...
            <div className="space-y-6 border-b border-gray-200 dark:border-gray-700 pb-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Define specific postal codes and their corresponding shipping prices for this zone. 
